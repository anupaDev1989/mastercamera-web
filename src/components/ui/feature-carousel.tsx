    ...
    ({ title, subtitle, images, children, onIndexChange, className, ...props }, ref) => {
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    'relative w-full min-h-screen flex flex-col items-center justify-center overflow-x-hidden bg-background text-foreground p-4 pt-24',
                    className
                )}
                {...props}
            >
                ...
                <div className="absolute inset-0 z-0 opacity-20" aria-hidden="true">
                    <div className="absolute bottom-0 left-[-20%] right-0 top-[-10%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,hsla(var(--primary)/0.25),transparent)]"></div>
                    <div className="absolute bottom-0 right-[-20%] top-[-10%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,hsla(var(--primary)/0.15),transparent)]"></div>
                </div>
                ...
                <div className="z-10 flex w-full flex-col items-center text-center space-y-8 md:space-y-12">
                    ...
                    <div className="space-y-4 flex flex-col items-center">
                        <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tighter max-w-4xl">
                            {title}
                        </h1>
                            ...
                            {images.map((image, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={cn(
                                            'absolute w-[200px] h-[400px] md:w-[280px] md:h-[600px] transition-all duration-500 ease-in-out',
                                    ...
                                    >
                                        <img
                                            src={image.src}
                                            alt={image.alt}
                                            className="object-contain h-full w-auto max-w-full rounded-3xl border-2 border-foreground/10 shadow-2xl"
                                        />
                                    </div>
                                );
                            })}
