        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#111;border-radius:16px;border:1px solid #222;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;text-align:center;border-bottom:1px solid #1f1f1f;">
              <p style="margin:0;font-size:13px;letter-spacing:0.12em;text-transform:uppercase;color:#888;">Master Camera</p>
              <h1 style="margin:12px 0 0;font-size:26px;font-weight:700;color:#fff;letter-spacing:-0.5px;">You're on the waitlist 🎉</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 32px;">
                <tr>
                  <td style="padding:12px 16px;background:#1a1a1a;border-radius:10px;margin-bottom:8px;">
                    <p style="margin:0;font-size:14px;color:#fff;">🚀&nbsp; <strong>First access</strong> — before the public launch</p>
                  </td>
                </tr>
                <tr><td style="height:8px;"></td></tr>
                <tr>
                  <td style="padding:12px 16px;background:#1a1a1a;border-radius:10px;">
          ...
          <tr>
            <td style="padding:24px 40px;border-top:1px solid #1f1f1f;text-align:center;">
              <p style="margin:0;font-size:12px;color:#444;">
                You received this because you signed up at mastercamera.app<br>
